...
} from "../funcs/compileQueryWithPartialEvaluation.js";
...
export { CompileQueryWithPartialEvaluationAcceptEnum } from "../funcs/compileQueryWithPartialEvaluation.js";
...
export class OpaApiClient extends ClientSDK {
  ...
  async executeDefaultPolicyWithInput(
    ...
    return unwrapAsync(executeDefaultPolicyWithInput(
      this,
      input,
      pretty,
      acceptEncoding,
  ...
  async executePolicy(
    ...
    return unwrapAsync(executePolicy(
      this,
      request,
      options,
    ));
  ...
  async executePolicyWithInput(
    ...
    return unwrapAsync(executePolicyWithInput(
      this,
      request,
      options,
    ));
  ...
  async executeBatchPolicyWithInput(
    ...
    return unwrapAsync(executeBatchPolicyWithInput(
      this,
      request,
      options,
    ));
   ...
   */
  async compileQueryWithPartialEvaluation(
  ...
  ): Promise<operations.CompileQueryWithPartialEvaluationResponse> {
    return unwrapAsync(compileQueryWithPartialEvaluation(
      this,
      request,
      options,
    ));
